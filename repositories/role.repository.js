...
const roleRepository={
  ...
  async create(entity) {
    ...
    try{
      ...
      for (const permission_id of entity.permission_ids) {
        for (const resource_id of entity.resource_ids) {
  ...
  async updateBy(information,condition){
    ...
    try{
      ...
      for (const permission_id of information.permission_ids) {
        for (const resource_id of information.resource_ids) {
          await trx('roles_permissions_resources').insert({
